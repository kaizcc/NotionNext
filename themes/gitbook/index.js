...
const LayoutBase = props => {
  ...
  return (
    <ThemeGlobalGitbook.Provider
      ...
      <div
        id='theme-gitbook'
        className={`${siteConfig('FONT_STYLE')} pb-16 md:pb-0 scroll-smooth bg-white dark:bg-slate-900 w-full h-full min-h-screen justify-center dark:text-gray-300`}>
        ...
        <main
          ...
          {fullWidth ? null : (
            <div className={'hidden md:block relative z-10 '}>
              <div className='w-80 pt-14 pb-4 sticky top-0 h-screen flex justify-between flex-col bg-white dark:bg-slate-800'>
                {/* 导航 */}
